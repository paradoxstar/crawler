...
storename = 'xiaoqu_shenzhen'# + time.strftime("%Y_%m_%d_%X", time.localtime())
...
def xiaoqu_page_search(db_xq,url_page=u"https://sz.lianjia.com/xiaoqu/luohuqu/pg1/"):
...
def area_xiaoqu_search(db_xq,region=u"luohuqu"):
   
    trytimes = 0
    url=u"https://sz.lianjia.com/xiaoqu/"+region+"/"
    while 1:
        try:
    ...
    for i in range(total_pages):
        url_page = u"https://sz.lianjia.com/xiaoqu/%s/pg%d/" % (region, i + 1)
