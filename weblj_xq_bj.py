...
def xiaoqu_page_search(db_xq,url_page=u"https://bj.lianjia.com/xiaoqu/dongcheng/pg1/"):
...
def area_xiaoqu_search(db_xq,region=u"dongcheng"):
    ...
    trytimes = 0
    url=u"https://bj.lianjia.com/xiaoqu/"+region+"/"
    while 1:
        try:
    ...
    for i in range(total_pages):
        url_page = u"https://bj.lianjia.com/xiaoqu/%s/pg%d/" % (region, i + 1)
